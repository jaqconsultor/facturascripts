...
class __TwigTemplate_8a04944d4bb7576afeffad14a3b9db36ec7426c0173db223099fda7e1dcae7ab extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
                    ...
                    <div class=\"card-body p-3\">
                        <div class=\"form-row\">
                            <div class=\"col-sm-2\">
                                ";
        // line 40
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", ["variant"], "method", false, false, false, 40), "html", null, true);
        echo "
                                <select name=\"referencia\" class=\"form-control mb-2\">
                                    <option value=\"\">";
        // line 42
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", ["all-variants"], "method", false, false, false, 42), "html", null, true);
        echo "</option>
                                    <option value=\"\">------</option>
                                    ";
        // line 44
        ...
        echo "                                </select>
                            ...
                            <div class=\"col\">
                                ";
        // line 50
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", ["images"], "method", false, false, false, 50), "html", null, true);
        echo "
                                ...
                                <p class=\"text-muted mb-2\">
                                    ";
        // line 54
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", ["help-server-accepts-filesize", ["%size%" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["currentView"] ?? null), "model", [], "any", false, false, false, 54), "getMaxFileUpload", [], "method", false, false, false, 54)]], "method", false, false, false, 54), "html", null, true);
        echo "
                                </p>
                            </div>
                            <div class=\"col-auto\">
        ...
        // line 60
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", ["add"], "method", false, false, false, 60), "html", null, true);
        echo "
                                </button>
                            </div>
                        </div>
            ...
            echo "\"/>
                            <div class=\"form-row align-items-center\">
                                <div class=\"col text-muted\">
                                    ";
            // line 90
            echo twig_escape_filter($this->env, ((twig_get_attribute($this->env, $this->source, $context["image"], "referencia", [], "any", false, false, false, 90)) ? (twig_get_attribute($this->env, $this->source, $context["image"], "referencia", [], "any", false, false, false, 90)) : (twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", ["all-variants"], "method", false, false, false, 90))), "html", null, true);
            echo "
                                </div>
                                <div class=\"col-auto\">
                                    ";
...
";
    ...
    public function macro_buttonDelete($__formName__ = null, $__i18n__ = null, ...$__varargs__)
    {
        ...
        try {
            // line 105
            echo "    ";
            $context["label"] = twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", ["delete-file"], "method", false, false, false, 105);
            // line 106
            echo "    ";
            $context["text"] = twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", ["are-you-sure"], "method", false, false, false, 106);
            // line 107
            echo "    ";
            $context["cancel"] = twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", ["cancel"], "method", false, false, false, 107);
            // line 108
            echo "    ";
            $context["confirm"] = twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", ["confirm"], "method", false, false, false, 108);
            // line 109
...
";
    ...
    {
        return new Source("", "Tab/ProductoImagen.html.twig", "C:\\xampp\\htdocs\\facturascripts\\Dinamic\\View\\Tab\\ProductoImagen.html.twig");
    }
}
